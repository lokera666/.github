...
# This is a script for creating sync branches matching tagged releases in the main Solidity repository.
...
# - If a remote called 'english' exists, it pointa at the main Solidity repository.
